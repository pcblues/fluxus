...
string wstring_to_string(const wstring &input)
{
    ...
    for(unsigned int i=0; i < input.size(); i++)
    {
        ...
        if(input[i] < 0x80)
        {
            output.push_back((byte2)input[i]);
        }
        // 110xxxxx 10xxxxxx
        else if(input[i] < 0x800)
        {
            output.push_back((byte2)(MASK2BYTES | input[i] >> 6));
            output.push_back((byte2)(MASKBYTE | input[i] & MASKBITS));
        }
        // 1110xxxx 10xxxxxx 10xxxxxx
        else if(input[i] < 0x10000)
        {
            output.push_back((byte2)(MASK3BYTES | input[i] >> 12));
            output.push_back((byte2)(MASKBYTE | input[i] >> 6 & MASKBITS));
            output.push_back((byte2)(MASKBYTE | input[i] & MASKBITS));
        }
        // 11110xxx 10xxxxxx 10xxxxxx 10xxxxxx
        else if(input[i] < 0x200000)
        {
            output.push_back((byte2)(MASK4BYTES | input[i] >> 18));
            output.push_back((byte2)(MASKBYTE | input[i] >> 12 & MASKBITS));
            output.push_back((byte2)(MASKBYTE | input[i] >> 6 & MASKBITS));
            output.push_back((byte2)(MASKBYTE | input[i] & MASKBITS));
        }
        ...
        {
            output.push_back((byte2)(MASK5BYTES | input[i] >> 24));
            output.push_back((byte2)(MASKBYTE | input[i] >> 18 & MASKBITS));
            output.push_back((byte2)(MASKBYTE | input[i] >> 12 & MASKBITS));
            output.push_back((byte2)(MASKBYTE | input[i] >> 6 & MASKBITS));
            output.push_back((byte2)(MASKBYTE | input[i] & MASKBITS));
        }
        ...
        {
            output.push_back((byte2)(MASK6BYTES | input[i] >> 30));
            output.push_back((byte2)(MASKBYTE | input[i] >> 18 & MASKBITS));
            output.push_back((byte2)(MASKBYTE | input[i] >> 12 & MASKBITS));
            output.push_back((byte2)(MASKBYTE | input[i] >> 6 & MASKBITS));
            output.push_back((byte2)(MASKBYTE | input[i] & MASKBITS));
